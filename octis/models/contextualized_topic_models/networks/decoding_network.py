...
from octis.models.contextualized_topic_models.networks.inference_network import CombinedInferenceNetwork, \
...
class DecoderNetwork(nn.Module):
    ...
    def __init__(self, input_size, bert_size, infnet, n_components=10, model_type='prodLDA',
                 ...
                 learn_priors=True, topic_prior_mean=0.0, topic_prior_variance=None, label_size=0):
        """
    ...
    def forward(self, x, x_bert, labels=None):
        ...
        return self.prior_mean, self.prior_variance, \
               posterior_mu, posterior_sigma, posterior_log_sigma, word_dist, topic_word, topic_doc, estimated_labels
